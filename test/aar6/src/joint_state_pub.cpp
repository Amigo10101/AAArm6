...
public:
        ...
        : Node("joint_state_watchdog")
    {
        ...
        // Publisher
        joint_pub_ = this->create_publisher<sensor_msgs::msg::JointState>("/joint_states_fixed", qos);
...
private:
    void jointCallback(const sensor_msgs::msg::JointState::SharedPtr msg)
    {
        ...
        sensor_msgs::msg::JointState new_msg = *msg;
        new_msg.header.stamp = this->now();
        joint_pub_->publish(new_msg);
    }
    ...
    void timerCallback()
    {
        ...
        if (elapsed.nanoseconds() > 50'000'000) // 50ms (relaxed watchdog)
        {
            // Re-publish last known joint state if we haven't heard from MCU
